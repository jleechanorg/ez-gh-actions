...
bash tests/assert_crash_containment_test.sh
git diff --check
git add scripts/host/ezgha-start-gate.sh src/backend.rs src/containment.rs src/config.rs src/service.rs src/main.rs src/docker_backend.rs src/github.rs src/reaper.rs config/config.toml.linux.example
